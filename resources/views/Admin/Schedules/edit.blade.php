...
@section('title', 'Edit Jadwal Terapis')
...
<div class="row">
    <div class="col-md-8 mx-auto">
        <h5 class="mb-4">Form Edit Jadwal Terapis</h5>
                ...
                <form action="{{ route('admin.schedules.update', $schedule->id) }}" method="POST">
                        ...
                        <select name="therapist_id" id="therapist_id" class="form-select @error('therapist_id') is-invalid @enderror">
                            ...
                            @foreach($therapists as $therapist)
                                <option value="{{ $therapist->id }}"
                                    {{ old('therapist_id', $schedule->therapist_id) == $therapist->id ? 'selected' : '' }}>
                                    {{ $therapist->full_name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="start_datetime" id="start_datetime"
                               ...
                               value="{{ old('start_datetime', $schedule->start_datetime ? \Carbon\Carbon::parse($schedule->start_datetime)->format('Y-m-d H:i') : '') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="end_datetime" id="end_datetime"
                               ...
                               value="{{ old('end_datetime', $schedule->end_datetime ? \Carbon\Carbon::parse($schedule->end_datetime)->format('Y-m-d H:i') : '') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="status" id="status" class="form-select @error('status') is-invalid @enderror">
                            ...
                            <option value="libur" {{ old('status', $schedule->status) == 'libur' ? 'selected' : '' }}>Libur</option>
                        </select>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-success">Perbarui Jadwal</button>
                    </div>
                </form>
            </div>
        </div>
