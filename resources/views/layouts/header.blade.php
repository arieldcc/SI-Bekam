  ...
  <ul class="list-unstyled">
        ...
        <div class="dropdown-header px-0 text-wrap header-notification-scroll position-relative" style="max-height: calc(100vh - 215px)">
          <div class="list-group list-group-flush w-100">
            ...
            <div class="list-group-item list-group-item-action">
              <div class="d-flex">
                <div class="flex-shrink-0">
                  <img src="{{ url('') }}/public/assets/images/user/avatar-3.jpg" alt="user-image" class="user-avtar" />
                </div>
                <div class="flex-grow-1 ms-1">
    ...
    <li class="dropdown pc-h-item header-user-profile">
      <a
        ...
        aria-expanded="false"
      >
        <img src="{{ url('') }}/public/assets/images/user/avatar-2.jpg" alt="user-image" class="user-avtar" />
        <span>
      ...
      <div class="dropdown-menu dropdown-user-profile dropdown-menu-end pc-h-dropdown">
        <div class="dropdown-header">
          ...
          <div class="profile-notification-scroll position-relative" style="max-height: calc(100vh - 280px)">
            ...
            {{-- <hr /> --}}
            {{-- <a href="{{ url('') }}/public/application/account-profile-v1.html" class="dropdown-item">
              <i class="ti ti-settings"></i>
              <span>Account Settings</span>
            </a>
            <a href="{{ url('') }}/public/application/social-profile.html" class="dropdown-item">
